...
// Default Search Page Widgets (used as fallback if tenant has no configured widgets for page=search)
export const DEFAULT_SEARCH_WIDGETS = [
    {
        id: 'def-search-layout',
